...
const Name tau_syn_fast_rise( "tau_syn_fast_rise" );
const Name tau_syn_fast_decay( "tau_syn_fast_decay" );
const Name tau_syn_slow_rise( "tau_syn_slow_rise" );
const Name tau_syn_slow_decay( "tau_syn_slow_decay" );
const Name NMDA_ratio( "NMDA_ratio" );
